...
identifier | The `io.l5d.h2.header.token` identifier | An identifier or list of identifiers. See [HTTP/2 Identifiers](#http-2-identifiers).
...
Key | Default Value | Description
--- | ------------- | -----------
kind | _required_ | Either [`io.l5d.h2.header.token`](#http-2-header-token-identifier), [`io.l5d.h2.path`](#http-2-path-identifier), or [`io.l5d.h2.ingress`](#http-2-ingress-identifier).
