...
* Add scoping to HTTP/2 identifiers:
  * The `io.l5d.headerToken` id has been renamed to `io.l5d.h2.header.token`.
  * The `io.l5d.headerPath` id has been renamed to `io.l5d.h2.path`.
